...
export const blogPosts: BlogPost[] = [
  ...
  { slug: "dong-bo-don-grabfood-shopee-food", title: "Đồng Bộ Đơn GrabFood & ShopeeFood Tự Động — Giảm 100% Nhập Tay", description: "3 workflow đồng bộ đơn delivery vào POS/kế toán. Giảm 100% nhập tay, đối soát tự động, báo cáo kênh bán hàng.", date: "2026-04-02", readTime: "12 phút", category: "F&B", featured: false },
  { slug: "quan-ly-chuoi-nha-hang-tu-dong", title: "Quản Lý Chuỗi Nhà Hàng Tự Động: Báo Cáo, Tồn Kho, Ca Làm", description: "4 workflow quản lý chuỗi nhà hàng: báo cáo đa chi nhánh, cảnh báo tồn kho, chấm công tự động.", date: "2026-04-02", readTime: "14 phút", category: "F&B", featured: false },
  { slug: "tang-khach-quay-lai-quan-cafe", title: "Tăng Khách Quay Lại Quán Cafe: Loyalty, Sinh Nhật, Zalo Tự Động", description: "3 workflow giữ chân khách cafe: loyalty tích điểm, chúc sinh nhật, re-engagement tự động qua Zalo OA.", date: "2026-04-02", readTime: "11 phút", category: "F&B", featured: false },
