...
export default function TangKhachQuayLaiQuanCafeBlog() {
  return (
    <BlogLayout
      slug="tang-khach-quay-lai-quan-cafe"
      title={<>Tăng Khách Quay Lại Quán Cafe:{" "}<span className="gradient-text">Loyalty, Sinh Nhật, Zalo Tự Động</span></>}
      description="67% khách uống 1 lần rồi không quay lại — không phải vì cafe dở, mà vì họ quên bạn tồn tại. 3 workflow tự động: loyalty tích điểm, chúc sinh nhật, nhắc khách quay lại — chạy 24/7 trên Zalo OA, không cần thêm nhân viên."
      breadcrumbLabel="F&B"
      badges={[
        { text: "F&B", color: "orange" },
        { text: "Loyalty", color: "pink" },
      ]}
