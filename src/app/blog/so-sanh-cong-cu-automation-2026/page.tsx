...
export default function SoSanhCongCuAutomation2026() {
  return (
    <BlogLayout
      ...
      title={<>Toàn Cảnh Công Cụ Tự Động Hóa Tại Việt Nam 2026:{" "}<span className="gradient-text">n8n, Zapier, Make & 20+ Nền Tảng</span></>}
      description="Thị trường automation toàn cầu đạt $89 tỷ vào 2026, nhưng SME Việt Nam vẫn loay hoay chọn công cụ. Bài viết này so sánh chi tiết 20+ nền tảng — từ 3 ông lớn (n8n, Zapier, Make) đến công cụ Việt Nam (KiotViet, Sapo, Haravan) — với giá VND, khả năng tích hợp, và decision framework giúp bạn chọn đúng."
      breadcrumbLabel="So sánh công cụ automation 2026"
      badges={[
        { text: "Pillar", color: "violet" },
        { text: "So sánh", color: "orange" },
    ...
    >
      ...
      <div className="not-prose my-8 bg-primary/5 border border-primary/20 rounded-2xl p-6 md:p-8">
        ...
        <div className="space-y-5">
          {[
            { n: "1", q: "Bạn cần tích hợp công cụ Việt Nam (KiotViet, MISA, Zalo OA)?", yes: "→ n8n (duy nhất hỗ trợ tốt)", no: "→ Tiếp câu 2" },
            { n: "2", q: "Ngân sách automation dưới 5 triệu/tháng?", yes: "→ n8n self-host hoặc Make Core", no: "→ Tiếp câu 3" },
            { n: "3", q: "Doanh nghiệp dùng Microsoft 365 (Outlook, Teams, SharePoint)?", yes: "→ Power Automate + n8n", no: "→ Tiếp câu 4" },
            { n: "4", q: "Cần AI Agent và xử lý thông minh?", yes: "→ n8n (70+ AI nodes, LangChain native)", no: "→ Tiếp câu 5" },
            { n: "5", q: "Team không biết code và chỉ cần kết nối 2-3 app quốc tế?", yes: "→ Zapier (đơn giản nhất) hoặc Make (rẻ hơn)", no: "→ n8n self-host (linh hoạt nhất, rẻ nhất)" },
          ].map((step) => (
