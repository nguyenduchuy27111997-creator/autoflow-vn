...
export default function AutomationDuLichKhachSanBlog() {
  return (
    <BlogLayout
      ...
      title={<>Automation Cho Du Lịch &amp; Khách Sạn —{" "}<span className="gradient-text">Booking, Check-in, Review Tự Động 2026</span></>}
      description="21 triệu lượt khách quốc tế, 58% đặt phòng qua OTA, 65% dùng điện thoại. Khách sạn của bạn đang xử lý tất cả bằng tay — xác nhận email, gọi điện nhắc check-in, nhờ khách để lại review. 4 workflow n8n giải phóng toàn bộ quy trình đó."
      breadcrumbLabel="Du lịch"
      badges={[
        { text: "Du lịch", color: "sky" },
        { text: "Khách sạn", color: "emerald" },
      ]}
