...
export default function AutomationSalonSpaBlog() {
  return (
    <BlogLayout
      slug="automation-salon-spa"
      title={<>Tự Động Hóa Salon & Spa —{" "}<span className="gradient-text">Đặt Lịch, Nhắc Hẹn & Chăm Khách VIP</span></>}
      description="15-30% khách đặt lịch salon & spa không đến mà không báo trước — mỗi ghế trống là doanh thu biến mất không thu hồi được. Trong khi đó, 46% khách hàng làm đẹp Việt Nam đặt lịch online và 67% ưu tiên kênh di động. 4 workflow tự động hóa toàn bộ vòng đời lịch hẹn — từ xác nhận đặt lịch đến nuôi dưỡng khách VIP — giảm no-show đến 70% mà không cần thêm nhân sự."
      breadcrumbLabel="Làm đẹp"
      badges={[
        { text: "Làm Đẹp", color: "pink" },
        { text: "Salon & Spa", color: "purple" },
      ]}
