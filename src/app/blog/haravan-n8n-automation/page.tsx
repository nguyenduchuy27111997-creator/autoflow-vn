...
export default function HaravanN8nAutomationBlog() {
  return (
    <BlogLayout
      slug="haravan-n8n-automation"
      title={<>Haravan + n8n: Tự Động Hóa Shop Online{" "}<span className="gradient-text">Đa Kênh Toàn Diện</span></>}
      description="Haravan phục vụ hơn 50.000 doanh nghiệp Việt với nền tảng thương mại điện tử đa kênh mạnh nhất nước. Nhưng khi đơn về từ website, Shopee, TikTok Shop cùng lúc — không có automation, đội vận hành sẽ chìm trong công việc thủ công. 4 workflow n8n giải quyết toàn bộ, chạy 24/7."
      breadcrumbLabel="E-commerce"
      badges={[
        { text: "E-commerce", color: "emerald" },
        { text: "Haravan · n8n", color: "blue" },
      ]}
