...
export default function ApiLaGiBlog() {
  return (
    <BlogLayout
      slug="api-la-gi"
      title={<>API Là Gì?{" "}<span className="gradient-text">Giải Thích Cho Chủ Doanh Nghiệp Không Biết Code</span></>}
      description="82% tổ chức đang xây dựng chiến lược API-first. Nhưng hầu hết chủ SME nghe đến API là thấy mơ hồ — &quot;cái đó dành cho dân kỹ thuật.&quot; Sai. Hiểu API sẽ giúp bạn tiết kiệm hàng chục giờ mỗi tuần mà không cần biết một dòng code."
