...
const COMMISSION_TABLE = [
  ...
  {
    pkg: "Hosting (hàng tháng)",
    range: "từ 1.5 triệu/tháng",
    commission: "50K/tháng × 3 tháng đầu",
    promo: "75K/tháng × 3 tháng đầu",
  },
];

const FAQ_ITEMS = [
  {
    q: "Khi nào tôi nhận commission?",
    a: "Sau khi khách hàng thanh toán đợt 1. AutoFlow chuyển khoản trong 7 ngày làm việc.",
  },
  {
    q: "Có giới hạn số lượng referral không?",
    a: "Không giới hạn. Giới thiệu càng nhiều, kiếm càng nhiều.",
  },
  {
    q: "Tôi cần làm gì sau khi được duyệt?",
    a: "Bạn nhận mã giới thiệu (VD: AF-TECHVN). Khi giới thiệu khách, họ nhắc mã này hoặc bạn kết nối trực tiếp qua Zalo.",
  },
  {
  ...
  },
  {
    ...
    a: "Hoàn toàn được! Bất kỳ ai có mạng lưới SME đều có thể tham gia — kế toán, business coach, freelancer.",
  },
  {
    q: "Ưu đãi 15% kéo dài bao lâu?",
    a: "3 tháng đầu kể từ ngày ra mắt chương trình. Đăng ký sớm để nhận rate cao nhất.",
  },
];
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (
          ...
          window.gtag("event", "partner_apply", {
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Bạn có khách hàng cần tự động hóa? Giới thiệu cho AutoFlow VN —
              mình xây dựng, bạn nhận hoa hồng. Đơn giản, minh bạch, trả nhanh.
            </p>
          </div>
            ...
            {[
              {
                step: "1",
                title: "Đăng ký",
                desc: "Điền form bên dưới. Nhận mã giới thiệu riêng trong 24h.",
                icon: "📝",
              },
              {
                step: "2",
                title: "Giới thiệu",
                desc: "Kết nối khách hàng với AutoFlow qua Zalo, email, hoặc nhắc mã giới thiệu.",
                icon: "🔗",
              },
              {
                step: "3",
                title: "Nhận thưởng",
                desc: "Khi dự án ký hợp đồng và khách thanh toán đợt 1 → nhận commission trong 7 ngày.",
                icon: "💰",
              },
            ].map((s) => (
              <div
          ...
          <div className="mb-16">
            ...
            <p className="text-sm text-slate-500 text-center mb-6">
              Đăng ký trong 3 tháng đầu nhận rate{" "}
              <strong className="text-accent">15%</strong> thay vì 10%
            </p>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-slate-50">
                      ...
                      <th className="text-left px-5 py-3 font-semibold text-accent">
                        🔥 Promo 15%
                      </th>
                    </tr>
                  </thead>
          ...
          {/* Who is it for */}
          <div className="mb-16">
            <h2 className="font-display font-bold text-xl text-slate-900 text-center mb-6">
              Ai phù hợp tham gia?
            </h2>
          ...
          <div className="mb-16" id="dang-ky">
            ...
            <p className="text-sm text-slate-500 text-center mb-6">
              Điền form — nhận mã giới thiệu trong 24h
            </p>

            {result?.success ? (
              <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-8 text-center max-w-lg mx-auto">
                <div className="text-4xl mb-3">🎉</div>
                <h3 className="font-display font-bold text-lg text-emerald-800 mb-2">
                  Đăng ký thành công!
                </h3>
                <p className="text-sm text-emerald-700 mb-4">
                  Mã giới thiệu tạm thời của bạn:{" "}
                  <strong className="text-lg">{result.code}</strong>
                </p>
                <p className="text-xs text-emerald-600">
                  Team AutoFlow sẽ liên hệ qua Zalo trong 24h để xác nhận và gửi
                  tài liệu hỗ trợ.
                </p>
              </div>
            ) : (
              ...
              >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-700 focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none bg-white"
                  >
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      value={form.clients_per_year}
                      onChange={(e) =>
                        setForm({ ...form, clients_per_year: e.target.value })
                      }
                      className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-700 focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none bg-white"
                    >
            ...
            <div className="max-w-2xl mx-auto space-y-2">
              {FAQ_ITEMS.map((item, i) => (
                ...
                >
                  ...
                  <div
                    className={`overflow-hidden transition-all ${faqOpen === i ? "max-h-40" : "max-h-0"}`}
                  >
          ...
          <div className="bg-slate-900 rounded-2xl p-8 md:p-10 text-center">
            ...
            <p className="text-slate-400 text-sm mb-6 max-w-md mx-auto">
              Đăng ký miễn phí. Không cam kết. Giới thiệu khi nào có khách phù
              hợp — AutoFlow lo phần còn lại.
            </p>
            <a
              href="#dang-ky"
