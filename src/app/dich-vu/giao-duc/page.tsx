        ...
        <section className="max-w-6xl mx-auto px-6 mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-7">
              ...
              <p className="text-xs text-slate-500 mt-1 mb-3">Cho trung tâm nhỏ</p>
              <p className="font-display font-extrabold text-2xl text-slate-900 mb-3">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-7">
              ...
              <p className="text-xs text-slate-500 mt-1 mb-3">Cho trung tâm 1–3 chi nhánh</p>
              <p className="font-display font-extrabold text-2xl text-slate-900 mb-3">
                20–35<span className="text-sm font-normal text-slate-500 ml-1">triệu</span>
              </p>
              <ul className="space-y-1.5 mb-5">
                {["3–5 workflows", "Training 2h cho team admin", "Support 14 ngày", "Timeline: 3–4 tuần"].map((f, i) => (
                  <li key={i} className="flex items-start gap-2 text-sm text-slate-600">
                    <span className="text-accent mt-0.5">✓</span>{f}
                  </li>
                ))}
