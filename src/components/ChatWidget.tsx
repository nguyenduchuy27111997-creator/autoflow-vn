        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2.5">
          ...
          >
            ...
            <svg width="28" height="28" viewBox="0 0 48 48" fill="none">
              <path d="M12.5 17.5h18.2L12.5 33.2V35h23v-3.5H17.3L35.5 15.8V14h-23v3.5z" fill="white"/>
            </svg>
          ...
          {/* AI Chat button — accent green, eye-catching */}
          <div className="relative">
            ...
            <button
              onClick={handleOpen}
              className="relative rounded-full bg-primary shadow-lg shadow-primary/25 flex items-center justify-center text-white hover:bg-primary-dark hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 transition-all"
              style={{ width: 52, height: 52 }}
