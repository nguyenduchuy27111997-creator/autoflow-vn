...
- [ ] **Domain** — Trỏ autoflowvn.com về hosting (Vercel/Netlify). Setup SSL (auto).
...
- [ ] **Search Console** — Verify domain tại search.google.com/search-console → Submit sitemap: `https://autoflowvn.com/sitemap.xml`
